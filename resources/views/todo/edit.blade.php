                    ...
                    <div class="px-4 sm:px-6 lg:px-8">
                        <div class="sm:flex sm:items-center">
                            <div class="sm:flex-auto">
                                <h1 class="text-base font-semibold leading-6 text-gray-900">Edit</h1>
                            </div>
                        ...
                        <div class="-mx-4 mt-8 sm:-mx-0">
                            ...
                            <form action="{{ route('todos.update',$todo->id) }}" method="post" id="todo-form">
                                    ...
                                    <div>
                                        <div
                                            ...
                                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                                ...
                                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                                    <select id="todo-type" name="todo_type_id" autocomplete="todo-type-name"
                                                        ...
                                                        <option @selected($todoType->id == $todo->todo_type_id) value="{{ $todoType->id }}">{{ $todoType->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                                ...
                                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                                    <input type="text" name="title" value="{{ $todo->title }}" placeholder="Title" id="title" autocomplete="title" class="block w-full max-w-2xl rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                </div>
                                            </div>
                                            ...
                                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                                ...
                                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                                    <input type="date" name="date" placeholder="Date" id="date"  value="{{ $todo->date }}" autocomplete="date" class="block w-full max-w-2xl rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                </div>
                                            </div>
                                            ...
                                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                                ...
                                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                                    <textarea id="description" placeholder="Write a few sentences about your doto." name="description" rows="3"
                                                        class="block w-full max-w-2xl rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $todo->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
